...
func _ready():
	...
	var btn_level_4 = $VBoxContainer/BtnLevel4
	var btn_level_5 = $VBoxContainer/BtnLevel5
	...
	btn_level_4.pressed.connect(func(): _start_level(3))
	btn_level_5.pressed.connect(func(): _start_level(4))
